...
import type { AgentFrontMatter as AgentMetadata } from "./frontmatter";
 ...
 *
 * @param subagents - Array of subagent metadata
 * @returns Formatted string with all subagent descriptions
 */
export function generateAgentsSection(subagents: AgentMetadata[]): string {
 ...
 *
 * @param subagents - Array of subagent metadata
 * @returns Formatted string with all subagent descriptions and oracle note
 */
export function generateAgentsSectionWithOracleNote(subagents: AgentMetadata[]): string {
  return subagents
    .map((agent) => {
